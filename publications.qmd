...
Merkle, E. C. (2026). [Bayesian estimation of normal and probit psychometric models](https://doi.org/10.1017/psy.2026.10119). *Psychometrika*.

Miller, M. B., Shoemaker, S. D., Freeman, L. K., Curtis, A. F., Merrill, J. E., & Merkle, E. C. (2026). [Predictive value of real-time memory tests in identifying alcohol-induced blackouts in situ](https://doi.org/10.1111/add.70446Digital Object Identifier (DOI)). *Addiction*.
